...
const ShoppingCart = () => {
  ...
  const addProductHandler = (id, price, image, quantity, totalPrice, name, brand) => {
    dispatch(
  ...
  const removeProductHandler = (id, price, image, quantity, totalPrice, name, brand) => {
    dispatch(
  ...
  return (
    <div className="mb-4">
      ...
      <div class="flex mt-10 mb-5" dir="rtl">
        <h3 class="font-semibold text-gray-600 text-xs uppercase w-2/5">جزییات محصول </h3>
        ...
        <h3 class="font-semibold text-gray-600 text-xs uppercase w-1/5 text-center">کل</h3>
      </div>
      {console.log(items)}
      {items.map((item) => (
          ...
          <div dir="rtl">
            <div class="flex items-center hover:bg-gray-100 -mx-8 px-6  h-full">
              ...
              <div class="flex justify-center w-1/5">
                ...
                >
                  <svg class="fill-current text-green-500 w-3" viewBox="0 0 448 512">
              ...
              <span class="text-center w-1/5 font-semibold text-sm">{addCommas(item.price, ",")} تومان</span>
              <span class="text-center w-1/5 font-semibold text-sm">{addCommas(+item.totalPrice, ",")} تومان</span>
            </div>
          </div>
